            ...
            <div className="container">
                ...
                >
                    ...
                    <div className="footer__about">
                        ...
                        <p>
                            Towards the goal of bringing new joy of dressing every day to millions of Vietnamese consumers. Let's work with Yolo towards a more active and positive life.                        </p>
                    </div>
                </Grid>
            </div>
        </footer>
